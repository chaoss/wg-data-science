...
![Bus Factor bar chart with balanced contributions ranging from 16% of commits to 6% of commits](images/bus-factor-bar-balanced.png "Bus Factor - generated by Augur")
...
![Active Contributors over time and growth analysis showing positive and negative contributor balances](images/active-contrib-over-time-bar-trend.png "Active Contributors over time - generate by GrimoireLab")
...
![Contributions by Data Source for various sources over time including GitHub, Twitter, pipermail, Slack](images/contrib-by-data-source.png "Contributions by Data Source - generated by GrimoireLab")
...
![Bus Factor pie chart showing that one contributor has made 61.8% of the commits with next largest contributors making 10.8% and 9.77%](images/bus-factor-pie-one-person.png "Bus Factor - generated by 8Knot / Augur")
...
![Contributor Growth by Engagement showing that the active contributors peaked in April 2023 and dwindled to nothing by October 2023](images/contributor-growth-by-engagement-bar.png "Contributor Growth by Engagement - generated by 8Knot / Augur")
...
* The [Responsiveness Practitioner Guide](https://docs.google.com/document/d/1bRe7m-kIr208H_MaubbU87QIJZJ18wc_g0mN_cEXO_c/edit) also has some similar suggestions that can apply to contributor sustainability. 
